...
#define STAR_UART_DATA_Pos               0                                      	/*!< UART_DATA_Pos: DATA Position */
#define STAR_UART_DATA_Msk              (0xFFul << STAR_UART_DATA_Pos)               	/*!< UART DATA: Data value */
        
#define STAR_UART_STATE_RXOR_Pos         3                                 	   	/*!< UART STATE: RXOR Position */
#define STAR_UART_STATE_RXOR_Msk         (0x1ul << STAR_UART_STATE_RXOR_Pos)         	/*!< UART STATE: RX buffer overrun, write 1 to clear */

#define STAR_UART_STATE_TXOR_Pos         2                                 	   	/*!< UART STATE: TXOR Position */
#define STAR_UART_STATE_TXOR_Msk         (0x1ul << STAR_UART_STATE_TXOR_Pos)         	/*!< UART STATE: TX buffer overrun, write 1 to clear */

#define STAR_UART_STATE_RXBF_Pos         1                                 		/*!< UART STATE: RXBF Position */
#define STAR_UART_STATE_RXBF_Msk         (0x1ul << STAR_UART_STATE_RXBF_Pos)         	/*!< UART STATE: RX buffer full, read-only */

#define STAR_UART_STATE_TXBF_Pos         0                                 		/*!< UART STATE: TXBF Position */
#define STAR_UART_STATE_TXBF_Msk         (0x1ul << STAR_UART_STATE_TXBF_Pos )        	/*!< UART STATE: TX buffer full, read-only */

#define STAR_UART_CTRL_HSTM_Pos          6                                       /*!< UART CTRL: HSTM Position */
#define STAR_UART_CTRL_HSTM_Msk          (0x01ul << STAR_UART_CTRL_HSTM_Pos)         	/*!< UART CTRL: High-speed test mode for TX only */

#define STAR_UART_CTRL_RXORIRQEN_Pos     5                                 		/*!< UART CTRL: RXORIRQEN Position */
#define STAR_UART_CTRL_RXORIRQEN_Msk     (0x01ul << STAR_UART_CTRL_RXORIRQEN_Pos)    	/*!< UART CTRL: RX overrun interrupt enable */

#define STAR_UART_CTRL_TXORIRQEN_Pos     4                                 		/*!< UART CTRL: TXORIRQEN Position */
#define STAR_UART_CTRL_TXORIRQEN_Msk     (0x01ul << STAR_UART_CTRL_TXORIRQEN_Pos)    	/*!< UART CTRL: TX overrun interrupt enable */

#define STAR_UART_CTRL_RXIRQEN_Pos       3                                 		/*!< UART CTRL: RXIRQEN Position */
#define STAR_UART_CTRL_RXIRQEN_Msk       (0x01ul << STAR_UART_CTRL_RXIRQEN_Pos)      	/*!< UART CTRL: RX interrupt enable */

#define STAR_UART_CTRL_TXIRQEN_Pos       2                                 		/*!< UART CTRL: TXIRQEN Position */
#define STAR_UART_CTRL_TXIRQEN_Msk       (0x01ul << STAR_UART_CTRL_TXIRQEN_Pos)      	/*!< UART CTRL: TX interrupt enable */

#define STAR_UART_CTRL_RXEN_Pos          1                                 		/*!< UART CTRL: RXEN Position */
#define STAR_UART_CTRL_RXEN_Msk          (0x01ul << STAR_UART_CTRL_RXEN_Pos)         	/*!< UART CTRL: RX enable */

#define STAR_UART_CTRL_TXEN_Pos          0                                 		/*!< UART CTRL: TXEN Position */
#define STAR_UART_CTRL_TXEN_Msk          (0x01ul << STAR_UART_CTRL_TXEN_Pos)         	/*!< UART CTRL: TX enable */

#define STAR_UART_INTSTATUS_RXORIRQ_Pos  3                                 		/*!< UART CTRL: RXORIRQ Position */
#define STAR_UART_CTRL_RXORIRQ_Msk       (0x01ul << STAR_UART_INTSTATUS_RXORIRQ_Pos) 	/*!< UART CTRL: RX overrun interrupt. Write 1 to clear */

#define STAR_UART_CTRL_TXORIRQ_Pos       2                                 		/*!< UART CTRL: TXORIRQ Position */
#define STAR_UART_CTRL_TXORIRQ_Msk       (0x01ul << STAR_UART_CTRL_TXORIRQ_Pos)      	/*!< UART CTRL: TX overrun interrupt. Write 1 to clear */

#define STAR_UART_CTRL_RXIRQ_Pos         1                                 		/*!< UART CTRL: RXIRQ Position */
#define STAR_UART_CTRL_RXIRQ_Msk         (0x01ul << STAR_UART_CTRL_RXIRQ_Pos)        	/*!< UART CTRL: RX interrupt. Write 1 to clear */

#define STAR_UART_CTRL_TXIRQ_Pos         0                                 		/*!< UART CTRL: TXIRQ Position */
#define STAR_UART_CTRL_TXIRQ_Msk         (0x01ul << STAR_UART_CTRL_TXIRQ_Pos)        	/*!< UART CTRL: TX interrupt. Write 1 to clear */

#define STAR_UART_BAUDDIV_Pos            0                                       /*!< UART BAUDDIV: BAUDDIV Position */
#define STAR_UART_BAUDDIV_Msk            (0xFFFFFul << STAR_UART_BAUDDIV_Pos)        	/*!< UART BAUDDIV: BAUDDIV Mask */



#define STAR_DUALTIMER1_LOAD_Pos            0                                           /* STAR_DUALTIMER1 LOAD: LOAD Position */
#define STAR_DUALTIMER1_LOAD_Msk            (0xFFFFFFFFul << STAR_DUALTIMER1_LOAD_Pos) 	/* STAR_DUALTIMER1 LOAD: LOAD Mask */
                                                                                                   
#define STAR_DUALTIMER1_VALUE_Pos           0                                           /* STAR_DUALTIMER1 VALUE: VALUE Position */
#define STAR_DUALTIMER1_VALUE_Msk           (0xFFFFFFFFul << STAR_DUALTIMER1_VALUE_Pos)	/* STAR_DUALTIMER1 VALUE: VALUE Mask */
                                                                                                   
#define STAR_DUALTIMER1_CTRL_EN_Pos         7                                           /* STAR_DUALTIMER1 Timer Enable: Timer Enable Position */
#define STAR_DUALTIMER1_CTRL_EN_Msk         (0x1ul << STAR_DUALTIMER1_CTRL_EN_Pos)     	/* STAR_DUALTIMER1 Timer Enable: Timer Enable Mask */
                                                                                                   
#define STAR_DUALTIMER1_CTRL_MODE_Pos       6                                           /* STAR_DUALTIMER1 Timer Mode: Timer Mode Position */
#define STAR_DUALTIMER1_CTRL_MODE_Msk       (0x1ul << STAR_DUALTIMER1_CTRL_MODE_Pos)   	/* STAR_DUALTIMER1 Timer Mode: Timer Mode Mask */
                                                                                                   
#define STAR_DUALTIMER1_CTRL_INTEN_Pos      5                                           /* STAR_DUALTIMER1 Interrupt Enable: Interrupt Enable Position */
#define STAR_DUALTIMER1_CTRL_INTEN_Msk      (0x1ul << STAR_DUALTIMER1_CTRL_INTEN_Pos)  	/* STAR_DUALTIMER1 Interrupt Enable: Interrupt Enable Mask */
                                                                                                   
#define STAR_DUALTIMER1_CTRL_PRESCALE_Pos   2                                             /* STAR_DUALTIMER1 Prescale bits: Prescale bits Position */
#define STAR_DUALTIMER1_CTRL_PRESCALE_Msk   (0x3ul << STAR_DUALTIMER1_CTRL_PRESCALE_Pos)  /* STAR_DUALTIMER1 Prescale bits: Prescale bits Mask */
                                                                                                   
#define STAR_DUALTIMER1_CTRL_SIZE_Pos       1                                             /* STAR_DUALTIMER1 Timer Size: Timer Size Position */
#define STAR_DUALTIMER1_CTRL_SIZE_Msk       (0x1ul << STAR_DUALTIMER1_CTRL_SIZE_Pos)      /* STAR_DUALTIMER1 Timer Size: Timer Size Mask */
                                                                                                   
#define STAR_DUALTIMER1_CTRL_ONESHOOT_Pos   0                                             /* STAR_DUALTIMER1 One-shot Count: One-shot Count Position */
#define STAR_DUALTIMER1_CTRL_ONESHOOT_Msk   (0x1ul << STAR_DUALTIMER1_CTRL_ONESHOOT_Pos)  /* STAR_DUALTIMER1 One-shot Count: One-shot Count Mask */
                                                                                                   
#define STAR_DUALTIMER1_INTCLR_Pos          0                                             /* STAR_DUALTIMER1 INTCLR: INT Clear Position */
#define STAR_DUALTIMER1_INTCLR_Msk          (0x1ul << STAR_DUALTIMER1_INTCLR_Pos)         /* STAR_DUALTIMER1 INTCLR: INT Clear  Mask */
                                                                                                   
#define STAR_DUALTIMER1_RAWINTSTAT_Pos      0                                             /* STAR_DUALTIMER1 RAWINTSTAT: Raw Int Status Position */
#define STAR_DUALTIMER1_RAWINTSTAT_Msk      (0x1ul << STAR_DUALTIMER1_RAWINTSTAT_Pos)     /* STAR_DUALTIMER1 RAWINTSTAT: Raw Int Status Mask */
                                                                                                   
#define STAR_DUALTIMER1_MASKINTSTAT_Pos     0                                             /* STAR_DUALTIMER1 MASKINTSTAT: Mask Int Status Position */
#define STAR_DUALTIMER1_MASKINTSTAT_Msk     (0x1ul << STAR_DUALTIMER1_MASKINTSTAT_Pos)    /* STAR_DUALTIMER1 MASKINTSTAT: Mask Int Status Mask */
                                                                                                   
#define STAR_DUALTIMER1_BGLOAD_Pos          0                                             /* STAR_DUALTIMER1 BGLOAD: Background Load Position */
#define STAR_DUALTIMER1_BGLOAD_Msk          (0xFFFFFFFFul << STAR_DUALTIMER1_BGLOAD_Pos)  /* STAR_DUALTIMER1 BGLOAD: Background Load Mask */
                                                                                                   
#define STAR_DUALTIMER2_LOAD_Pos            0                                             /* STAR_DUALTIMER2 LOAD: LOAD Position */
#define STAR_DUALTIMER2_LOAD_Msk            (0xFFFFFFFFul << STAR_DUALTIMER2_LOAD_Pos)    /* STAR_DUALTIMER2 LOAD: LOAD Mask */
                                                                                                   
#define STAR_DUALTIMER2_VALUE_Pos           0                                             /* STAR_DUALTIMER2 VALUE: VALUE Position */
#define STAR_DUALTIMER2_VALUE_Msk           (0xFFFFFFFFul << STAR_DUALTIMER2_VALUE_Pos)   /* STAR_DUALTIMER2 VALUE: VALUE Mask */
                                                                                                   
#define STAR_DUALTIMER2_CTRL_EN_Pos         7                                             /* STAR_DUALTIMER2 Timer Enable: Timer Enable Position */
#define STAR_DUALTIMER2_CTRL_EN_Msk         (0x1ul << STAR_DUALTIMER2_CTRL_EN_Pos)        /* STAR_DUALTIMER2 Timer Enable: Timer Enable Mask */
                                                                                                   
#define STAR_DUALTIMER2_CTRL_MODE_Pos       6                                             /* STAR_DUALTIMER2 Timer Mode: Timer Mode Position */
#define STAR_DUALTIMER2_CTRL_MODE_Msk       (0x1ul << STAR_DUALTIMER2_CTRL_MODE_Pos)      /* STAR_DUALTIMER2 Timer Mode: Timer Mode Mask */
                                                                                                   
#define STAR_DUALTIMER2_CTRL_INTEN_Pos      5                                             /* STAR_DUALTIMER2 Interrupt Enable: Interrupt Enable Position */
#define STAR_DUALTIMER2_CTRL_INTEN_Msk      (0x1ul << STAR_DUALTIMER2_CTRL_INTEN_Pos)     /* STAR_DUALTIMER2 Interrupt Enable: Interrupt Enable Mask */
                                                                                                   
#define STAR_DUALTIMER2_CTRL_PRESCALE_Pos   2                                             /* STAR_DUALTIMER2 Prescale bits: Prescale bits Position */
#define STAR_DUALTIMER2_CTRL_PRESCALE_Msk   (0x3ul << STAR_DUALTIMER2_CTRL_PRESCALE_Pos)  /* STAR_DUALTIMER2 Prescale bits: Prescale bits Mask */
                                                                                                   
#define STAR_DUALTIMER2_CTRL_SIZE_Pos       1                                             /* STAR_DUALTIMER2 Timer Size: Timer Size Position */
#define STAR_DUALTIMER2_CTRL_SIZE_Msk       (0x1ul << STAR_DUALTIMER2_CTRL_SIZE_Pos)      /* STAR_DUALTIMER2 Timer Size: Timer Size Mask */
                                                                                                   
#define STAR_DUALTIMER2_CTRL_ONESHOOT_Pos   0                                             /* STAR_DUALTIMER2 One-shot Count: One-shot Count Position */
#define STAR_DUALTIMER2_CTRL_ONESHOOT_Msk   (0x1ul << STAR_DUALTIMER2_CTRL_ONESHOOT_Pos)  /* STAR_DUALTIMER2 One-shot Count: One-shot Count Mask */
                                                                                                   
#define STAR_DUALTIMER2_INTCLR_Pos          0                                             /* STAR_DUALTIMER2 INTCLR: INT Clear Position */
#define STAR_DUALTIMER2_INTCLR_Msk          (0x1ul << STAR_DUALTIMER2_INTCLR_Pos)         /* STAR_DUALTIMER2 INTCLR: INT Clear  Mask */
                                                                                                   
#define STAR_DUALTIMER2_RAWINTSTAT_Pos      0                                             /* STAR_DUALTIMER2 RAWINTSTAT: Raw Int Status Position */
#define STAR_DUALTIMER2_RAWINTSTAT_Msk      (0x1ul << STAR_DUALTIMER2_RAWINTSTAT_Pos)     /* STAR_DUALTIMER2 RAWINTSTAT: Raw Int Status Mask */
                                                                                                   
#define STAR_DUALTIMER2_MASKINTSTAT_Pos     0                                             /* STAR_DUALTIMER2 MASKINTSTAT: Mask Int Status Position */
#define STAR_DUALTIMER2_MASKINTSTAT_Msk     (0x1ul << STAR_DUALTIMER2_MASKINTSTAT_Pos)    /* STAR_DUALTIMER2 MASKINTSTAT: Mask Int Status Mask */
                                                                                                   
#define STAR_DUALTIMER2_BGLOAD_Pos          0                                             /* STAR_DUALTIMER2 BGLOAD: Background Load Position */
#define STAR_DUALTIMER2_BGLOAD_Msk          (0xFFFFFFFFul << STAR_DUALTIMER2_BGLOAD_Pos)  /* STAR_DUALTIMER2 BGLOAD: Background Load Mask */

#define STAR_Watchdog_INTCLR_Pos             0                                              /* STAR_Watchdog INTCLR: Int Clear Position */
#define STAR_Watchdog_INTCLR_Msk            (0x1ul << STAR_Watchdog_INTCLR_Pos)             /* STAR_Watchdog INTCLR: Int Clear Mask */
...
#define SSP_SR_BSY_Pos          4           			// PrimeCell SSP busy flag
#define SSP_SR_BSY_Msk          (1UL<<SSP_SR_BSY_Pos)
#define SSP_SR_BSY_TX_Pos       5           			// SSP TX busy flag
...
#define STAR_I2C_TX_ENA_Pos  0
#define STAR_I2C_TX_ENA_Msk  (1UL<<STAR_I2C_TX_ENA_Pos)


#define STAR_I2C_TX_BUFFER_LEVEL_Pos  2
#define STAR_I2C_TX_BUFFER_LEVEL_Msk  (0x3UL<<STAR_I2C_TX_BUFFER_LEVEL_Pos)

#define STAR_I2C_START_SET_Pos  4
#define STAR_I2C_START_SET_Msk  (0x1UL<<STAR_I2C_START_SET_Pos)

#define STAR_I2C_STOP_SET_Pos  5
#define STAR_I2C_STOP_SET_Msk  (0x1UL<<STAR_I2C_STOP_SET_Pos)

#define STAR_I2C_RX_ENA_Pos  8
#define STAR_I2C_RX_ENA_Msk  (1UL<<STAR_I2C_RX_ENA_Pos)

#define STAR_I2C_RX_BUFFER_LEVEL_Pos  10
#define STAR_I2C_RX_BUFFER_LEVEL_Msk  (0x3UL<<STAR_I2C_RX_BUFFER_LEVEL_Pos)

#define STAR_I2C_TX_NUM_Pos  16
#define STAR_I2C_TX_NUM_Msk  (0xFUL<<STAR_I2C_TX_NUM_Pos)

#define STAR_I2C_SWRST_Pos 31
#define STAR_I2C_SWRST_Msk (1UL<<STAR_I2C_SWRST_Pos)
...
#define STAR_SSP0_BASE         (STAR_APB_BASE + 0xB000UL)
#define STAR_SSP1_BASE         (STAR_APB_BASE + 0xC000UL)
...
#define STAR_SSP0               ((SSP_TypeDef  *) STAR_SSP0_BASE )
#define STAR_SSP1               ((SSP_TypeDef  *) STAR_SSP1_BASE )
